...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="商家账号" prop="shangjiazhanghao"></el-table-column>
      <el-table-column label="商家姓名" prop="shangjiaxingming"></el-table-column>
                        ...
                        if(item.type==1||item.type==3) {
                            ...
                            this.$http.post(table+'/update', this.user).then(res => {
                                ...
                                this.$http.post(`orders/update`, item).then(res => {
                                    if(item.tablename == `chongwuchanpin`){
                                        // 加回库存数量
                                        good.alllimittimes = good.alllimittimes + item.buynumber;
                                        this.$http.post(`chongwuchanpin/update`, good).then(res => {
                                        });
                                    }
                                    this.$message({

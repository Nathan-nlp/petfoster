  ...
  <div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    <el-table
      ...
      <el-table-column
        label="商家账号">
        <template slot-scope="scope">
            <span style="margin-left: 10px;flex: 1">{{ scope.row.shangjiazhanghao }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column
        label="商家姓名">
        <template slot-scope="scope">
            <span style="margin-left: 10px;flex: 1">{{ scope.row.shangjiaxingming }}</span>
        </template>
      </el-table-column>
					...
					if (this.$route.query.id != undefined || this.$route.query.type != undefined) {
						...
						if (this.$route.query.type == 1) {
							this.tableData.push({
								...
								shangjiazhanghao: this.$route.query.shangjiazhanghao,
								shangjiaxingming: this.$route.query.shangjiaxingming,
                    ...
                    // 更新库存信息
                     this.$http.post(`${item.tablename}/update`, data).then( res => {
                        ...
                        let order = {
                            ...
                            shangjiaxingming: item.shangjiaxingming,

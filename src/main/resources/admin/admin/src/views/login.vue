<template>
  ...
  "justifyContent":"flex-end"
			...
			<el-form :style='{"border":"1px solid rgba(255,255,255,0.3)","padding":"40px 100px 40px","margin":"0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"flex","justifyContent":"center","minHeight":"100vh","borderRadius":"8px","flexWrap":"wrap","background":"rgba(255,255,255,0.8)","width":"33%","fontSize":"14px","position":"relative","height":"auto","backdropFilter":"blur(5px)"}'>
        <div v-if="true" :style='{"padding":"0 0 10px","margin":"0 0 0px","borderColor":"#ddd","color":"#53d192","textAlign":"center","display":"inline-block","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"1.2","fontSize":"22px","borderStyle":"solid","fontWeight":"500"}' class="title-container">宠物寄养平台登录</div>
        <div v-if="loginType==1" class="list-item" :style='{"width":"100%","margin":"0 0 20px","position":"relative","alignItems":"center","flexWrap":"wrap","display":"flex"}'>
          ...
          <input :style='{"padding":"0 10px","borderColor":"rgba(83,209,146,0.5)","color":"#666","borderRadius":"4px","background":"rgba(255,255,255,0.7)","borderWidth":"1px","width":"100%","fontSize":"inherit","borderStyle":"solid","height":"40px"}' placeholder="请输入用户名" name="username" type="text" v-model="rulesForm.username">
        </div>
        <div v-if="loginType==1" class="list-item" :style='{"width":"100%","margin":"0 0 20px","position":"relative","alignItems":"center","flexWrap":"wrap","display":"flex"}'>
          ...
          <input :style='{"padding":"0 10px","borderColor":"rgba(83,209,146,0.5)","color":"#666","borderRadius":"4px","background":"rgba(255,255,255,0.7)","borderWidth":"1px","width":"100%","fontSize":"inherit","borderStyle":"solid","height":"40px"}' placeholder="请输入密码" name="password" type="password" v-model="rulesForm.password">
        </div>
  ...
  <el-button :style='{"border":"0px solid #4FA1D9","cursor":"pointer","padding":"0 20px","color":"#fff","textAlign":"center","letterSpacing":"4px","outline":"none","borderRadius":"6px","background":"#53d192","width":"100%","fontSize":"16px","height":"40px"}' @click="register('shangjia')">注册商家</el-button>
</div>

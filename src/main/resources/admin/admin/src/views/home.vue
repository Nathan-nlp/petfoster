...
<div class="content" :style='{"minHeight":"100vh","padding":"0px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240409/022fa5d23027406e8723c4bfa0031326.png) no-repeat center top / cover","display":"block","width":"100%","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#fff","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7e8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#3598dc","borderWidth":"0px","flex":"1","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('chongwuxinxi','首页总数')">
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","background":"none","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{chongwuxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>宠物信息总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7f8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#e7505a","borderWidth":"0px","flex":"1","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('chongwuyanghuzhishi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"50px","justifyContent":"center","height":"50px"}'>
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{chongwuyanghuzhishiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>宠物养护知识总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7f8e8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#32c5d2","borderWidth":"0px","flex":"1.2","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('chongwufenxiang','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"50px","justifyContent":"center","height":"50px"}'>
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{chongwufenxiangCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>宠物分享总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="chongwuxinxiChart1" class="echarts1" v-if="isAuth('chongwuxinxi','首页统计')"></div>
		<div id="chongwuyanghuzhishiChart1" class="echarts2" v-if="isAuth('chongwuyanghuzhishi','首页统计')"></div>
		<div id="chongwufenxiangChart1" class="echarts3" v-if="isAuth('chongwufenxiang','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	data() {
		return {
            chongwuxinxiCount: 0,
            chongwuyanghuzhishiCount: 0,
            chongwufenxiangCount: 0,
	...
	methods:{
        ...
        this.$http({
            url: "chongwuxinxi/group/chongwuleixing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].chongwuleixing);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].chongwuleixing
                    })
                }
                var option = {};
				let titleObj = this.pie.title
				titleObj.text = '宠物信息类型占比'
                ...
                // 使用刚指定的配置项和数据显示图表。
                chongwuxinxiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    chongwuxinxiChart1.resize();
                };
            }
        });
      })
		...
		getchongwuyanghuzhishiCount() {
			this.$http({
				url: `chongwuyanghuzhishi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.chongwuyanghuzhishiCount = data.data
				}
			})
		},
		chongwuyanghuzhishiChat1() {
			this.$nextTick(()=>{

        var chongwuyanghuzhishiChart1 = echarts.init(document.getElementById("chongwuyanghuzhishiChart1"),'macarons');
        this.$http({
            url: "chongwuyanghuzhishi/group/yanghufenlei",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].yanghufenlei);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].yanghufenlei
                    })
                }
                var option = {};
				let titleObj = this.pie.title
				titleObj.text = '养护分类占比'
                ...
                // 使用刚指定的配置项和数据显示图表。
                chongwuyanghuzhishiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    chongwuyanghuzhishiChart1.resize();
                };
            }
        });
      })
		...
		getchongwufenxiangCount() {
			this.$http({
				url: `chongwufenxiang/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.chongwufenxiangCount = data.data
				}
			})
		},
		chongwufenxiangChat1() {
			this.$nextTick(()=>{

        var chongwufenxiangChart1 = echarts.init(document.getElementById("chongwufenxiangChart1"),'macarons');
        this.$http({
            url: "chongwufenxiang/group/fenxiangleixing",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].fenxiangleixing);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].fenxiangleixing
                    })
                }
                var option = {};
				let titleObj = this.bar.title
				titleObj.text = '宠物分享类型统计'
                ...
                // 使用刚指定的配置项和数据显示图表。
                chongwufenxiangChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    chongwufenxiangChart1.resize();
                };
            }
        });
      })

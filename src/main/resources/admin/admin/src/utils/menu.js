                ...
                "backMenu": [
                    ...
                    },
                    {
                        "child": [
                            ...
                            {
                                "allButtons": ["查看",  "删除", "宠物信息类型占比", "首页总数", "首页统计"],
                                "appFrontIcon": "cuIcon-link",
                                "buttons": ["查看",  "删除","首页总数", "首页统计"],
                                "menu": "宠物信息",
                                "tableName": "chongwuxinxi"
                            },
                            {
                                "allButtons": ["查看",  "删除", "宠物领养类型占比", "首页总数", "首页统计"],
                                "appFrontIcon": "cuIcon-link",
                                "buttons": ["查看",  "删除","首页总数", "首页统计"],
                                "menu": "宠物领养",
                ...
                "backMenu": [
                    {
                        "child": [
                            ...
                            {
                                "allButtons": [ "查看", "修改", "审核","删除", "宠物领养类型占比", "首页总数", "首页统计"],
                                "appFrontIcon": "cuIcon-link",
                                "buttons": ["查看", "修改","审核", "删除",  "首页总数", "首页统计"],
                                "menu": "宠物领养",
                                "tableName": "chongwulingyang"
                            }
                        ],
